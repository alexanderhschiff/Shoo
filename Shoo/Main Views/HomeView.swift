...
struct HomeView: View {
	...
	var body: some View {
		...
		.background(LinearGradient(gradient: Gradient(colors: [Color(UIColor.secondarySystemBackground), Color(UIColor.systemBackground)]), startPoint: .top, endPoint: .bottom))
